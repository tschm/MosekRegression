# Contributing to mosektools

This document is a guide to contributing to mosektools
...
## Building mosektools from source

You'll need to build mosektools locally in order to start editing code.
To install mosektools from source, clone the Github
...
To contribute to mosektools, send us pull requests.
For those new to contributing, check out Github's
[guide](https://help.github.com/articles/using-pull-requests/).

Once you've made your pull request, a member of the mosektools
...
If you'd like to add a new feature to mosektools, please do propose your
...
- Read the mosektools source and enhance the documentation,
  or address TODOs
- Browse the [issue tracker](https://github.com/tschm/mosekregression/issues),
...
mosektools tests live in the directory `tests`,
